...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            >
                Unleash your creativity with AI. Transform your ideas into visual art in seconds—just type and see the magic unfold.
            </motion.p>
            ...
            >
                {Array(6).fill('').map((item, index) => (
                    <motion.img
                        ...
                        width={70}
                        key={index}
                        src={index % 2 === 0 ? assets.images : assets.images_1}
